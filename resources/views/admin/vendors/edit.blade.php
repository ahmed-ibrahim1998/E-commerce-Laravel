                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل المتجر </h4>
...
@section('script')
    ...
    <script>
        ...
        function initAutocomplete() {
            ...
            //  show the information of the map
            infoWindow = new google.maps.InfoWindow;
            geocoder = new google.maps.Geocoder();

            // show the marker of map   شوف العلامه الحمراء اللي بتظهر لما احدد المكان
            marker = new google.maps.Marker({
                position: pos,
                map: map,
                title: '{{ $vendor->name }}'  // عنوان التجار
